...
Java_cn_tosee_parseh264_H264Utils_getWidth_1Height_1fromPacket(JNIEnv *env, jobject thiz,
                                                                   jbyteArray packets,
                                                                   jint length) {
    bool sucess=false;
...
Java_cn_tosee_parseh264_H264Utils_getWidth(JNIEnv *env, jobject thiz) {
    return dst_width;
}extern "C"
JNIEXPORT jint JNICALL
Java_cn_tosee_parseh264_H264Utils_getHeight(JNIEnv *env, jobject thiz) {
    return dst_height;
}